...
class IDMap:
    ...
    ID_LIST = [ 
        ...
        BEAM_MONITORING_FC_ID, BEAM_MONITORING_MIDDLE_ID, BEAM_MONITORING_ZD_ID, ALPHA_SOURCE_ID
    ]
    ...
    LABEL_LIST = [
        ...
        BEAM_MONITORING_FC_LABEL, BEAM_MONITORING_MIDDLE_LABEL, BEAM_MONITORING_ZD_LABEL, ALPHA_SOURCE_LABEL
    ]
