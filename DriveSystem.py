...
arrayEdge_W=14.5 #distance from end of array to edge of Si # Liverpool array
threeW=8*10
threeH=13*10
fourW=8*10
fourH=13*10
...
#home2=-40118.0/200-arrayW  # at the maximum encoder position, the end of the Liverpool array is in the centre of the magnet
...
class DriveView:
	def __init__(self,panel):
		...
		#Arrow who shows the distance for array to target
	...
	def updatePositions(self,pos):
		...
		dis2_3 = 1630.81 - 120907.0/200.0 # distance between array support and target at encoder 0 for both axes
		dis2_3 += pos[1]/200.0 # add on distance of array from encoder = 0
		dis2_3 -= pos[0]/200.0 # add on distance of target from encoder = 0
		dis2_3 -= 624.5 # distance from array support to tip of array
		dis2_3 += 0.92 # offset from the PEEK target ladder and the MEG

		#coord2 = home2 - pos[1]/200   # back of the array
		...
		coord3 -= 120907.0/200.0 # coordinate at encoder = 0
		coord3 -= pos[0]/200.0 # now at the cuurent encoder position

		coord2 = coord3 - dis2_3 - arrayW - arrayEdge_W
		...
		self.drawArrow2(recoil_target_dist)
		self.number1.remove()
		self.number2.remove()
		self.number3.remove()
		self.number4.remove()
