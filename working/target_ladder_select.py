...
ID_MAP = IDMap(f"{SOURCE_DIRECTORY}/id_label_map.txt")
...
#        self.control_view = ControlView(self.downstream_movement_panel,self.)
    ...
    def move_motors(self,e):
        ...
        if self.downstream_movement_panel.get_selected_item_id() == None:
            ...
            print(f"Movement to { ID_MAP.get_label( self.downstream_movement_panel.get_selected_item_id() ) } requested")
            ...
            # Tell motors to move with function in ControlView class
            self.downstream_movement_panel.window.controlview.XYElementMoveAction(e)
